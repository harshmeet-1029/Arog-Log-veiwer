...
# Upload pre-built binaries to an existing GitHub release
# No building - just uploading!
################################################################################
...
if [ -z "$GITHUB_TOKEN" ]; then
    ...
    echo "  ./release-only.sh $VERSION ghp_yourtoken"
    echo "OR"
    echo "  export GITHUB_TOKEN=ghp_yourtoken"
    echo "  ./release-only.sh $VERSION"
    echo ""
    exit 1
fi
...
if [ $FAILED_COUNT -eq 0 ]; then
    echo -e "${GREEN}✅ SUCCESS! All files uploaded${NC}"
    echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
